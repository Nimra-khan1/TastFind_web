...
const BrowseRecipes = () => {
  ...
  const recipes = [
    ...
    },
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGGSOoGFcsf7iSbWps5hf_d19iGP55T9nHog&s",
    ...
    },
    {
      ...
      ingredients: ["Ground beef", "Taco shells", "Toppings", "Salsa", "Guacamole"],
      preparationSteps: [
    ...
    {
      name: "LEMON TART",
      image: "https://media-cldnry.s-nbcnews.com/image/upload/newscms/2023_51/2043794/matt-adlard-lemon-tart-1x1-zz-231220.jpg",
    ...
    {
      name: "PANCAKES",
      image: "https://www.inspiredtaste.net/wp-content/uploads/2016/07/Pancake-Recipe-1-1200.jpg",
    ...
    {
      name: "CAPRESE SALAD",
      image: "https://whatsgabycooking.com/wp-content/uploads/2023/06/Dinner-Party-__-Traditional-Caprese-1.jpg",
    ...
    },
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJ4gkQUw7oWIXwDYw5kMM9BB8CZs8cj1e8-A&s",
      ingredients: ["Arborio rice", "Mushrooms", "Onions", "Garlic", "Parmesan cheese"],
      preparationSteps: [
    ...
    <div className="browse-recipes">
      ...
      {selectedRecipe && (
        <div className="preparation-details" id="preparation-steps">
          <h4 className="preparation-title">PREPERATION STEP FOR {selectedRecipe.name}:</h4>
          ...
          <div className="details-content">
            ...
            <img src={selectedRecipe.image} alt={selectedRecipe.name} className="detail-image" />
          </div>
